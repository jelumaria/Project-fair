...
const Footer = () => {
  return (
    ...
    <div className="d-flex justify-content-between">
      ...
      <div className='d-flex flex-column'>
        ...
        <div className='d-flex'>
          <input placeholder='Enter your Email here' type="text" className='form-vontrol me-2' />
        ...
        <div className='d-flex justify-content-between mt-3'>
          ...
          <a href="https://x.com/?lang=en-in&mx=2" style={{textDecoration:'none',color:'white'}} target='_blank'><i className='fa-brands fa-phone'></i></a>
    ...
    <p className='text-center mt-3'>Copyright &copy;July 2024 Btach,Project fair App.Built with React</p>
  </div>
  )
}
